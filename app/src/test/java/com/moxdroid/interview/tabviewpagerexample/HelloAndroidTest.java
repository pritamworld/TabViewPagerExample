...
public class HelloAndroidTest extends ActivityInstrumentationTestCase2<HelloAndroid> {
    ...
    public HelloAndroidTest() {
        ...
        super("com.moxdroid.interview.tabviewpagerexample", HelloAndroid.class);
    }
    ...
    protected void setUp() throws Exception {
        ...
        mView = (TextView) mActivity.findViewById(com.moxdroid.interview.tabviewpagerexample.R.id.textview2);
        resourceString = mActivity.getString(com.moxdroid.interview.tabviewpagerexample.R.string.hello_world);
